...
#acui_exporter.user-exporter__exporting .user-exporter-progress-wrapper{
		...
		<table class="form-table">
			<tbody>
				...
				<tr id="acui_timestamp_wrapper" valign="top">
					...
					<td>
                        <?php ACUIHTML()->checkbox( array( 'name' => 'convert_timestamp', 'current' => 0, 'compare_value' => $settings->get( 'convert_timestamp' ) ) ); ?>
				...
				<tr id="acui_order_fields_alphabetically_wrapper" valign="top">
					...
					<td>
                        <?php ACUIHTML()->checkbox( array( 'name' => 'order_fields_alphabetically', 'current' => 0, 'compare_value' => $settings->get( 'order_fields_alphabetically' ) ) ); ?>
                ...
                <tr id="acui_order_fields_double_encapsulate_serialized_values" valign="top">
					...
					<td>
                        <?php ACUIHTML()->checkbox( array( 'name' => 'double_encapsulate_serialized_values', 'current' => 0, 'compare_value' => $settings->get( 'double_encapsulate_serialized_values' ) ) ); ?>                    
	...
	function save_settings(){
		if( isset( $_POST['settings'] ) ){
			...
			ACUISettings()->save_multiple( 'export_backend', $_POST );
		}
	}
}
